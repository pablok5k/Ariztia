...
******************************************************************************************************
    ...
    lo_interfase->obj_scales->create_by_url( ).

    lo_interfase->obj_scales->set_general_parameters( ).

    lo_interfase->obj_scales->set_request_method( ).

    lo_interfase->obj_scales->set_authorization( ).

    lo_interfase->obj_scales->lo_client->request->if_http_entity~set_content_type( if_rest_media_type=>gc_appl_json ).

    lo_interfase->obj_scales->lo_client->request->set_header_field(
      exporting
        name  = 'httpscontent-type'
        value = 'application/json' ).
